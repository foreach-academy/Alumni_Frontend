...
return <>
    ...
    <div className="block_inscription_entreprise">
        ...
        <div className="premiere_partie_inscription_entreprise">
            <input type="email" name="email" defaultValue={email} placeholder="Email" onChange={(e) => {
                setEmail(e.target.value)
            }} className="input_inscription_entreprise" required/>
            <input type="password" name="mot de passe" defaultValue={mdp} placeholder="Mot de passe" onChange={(e) => {
                setMdp(e.target.value)
            }} className="input_inscription_entreprise" required/>
            <input type="text" name="nom" defaultValue={nom} placeholder="Nom" onChange={(e) => {
                setNom(e.target.value)
            }} className="input_inscription_entreprise" required/>
        </div>
        <div className="deuxieme_partie_inscription_entreprise">
            <input type="text" name="prenom" defaultValue={prenom} placeholder="Prenom" onChange={(e) => {
                setPrenom(e.target.value)
            }} className="input_inscription_entreprise" required/>
            <input type="text" name="formation" defaultValue={entreprise} placeholder="Nom de l'entreprise"
                   onChange={(e) => {
                       setEntreprise(e.target.value)
                   }} className="input_inscription_entreprise" required/>
            <input type="text" name="promotion" defaultValue={fonction} placeholder="Fonction dans l'entreprise"
                   onChange={(e) => {
    ...
    <div className="case_a_cocher_inscription_entreprise">
        ...
        <label for="valider_inscription">En m'inscrivant, j'accepte que les données renseignées soient utilisées par
            l'équipe de ForEach Academy.</label>
    </div>
