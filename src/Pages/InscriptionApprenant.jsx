...
return <>
    ...
    <div className="block_inscription_apprenant">
        ...
        <div className="premiere_partie_input">
            ...
            }} className="input_inscription_apprenant" required/>
        ...
        <div className="deuxieme_partie_input">
            ...
            <input type="text" name="formation" defaultValue={formation} placeholder="Formation" onChange={(e) => {
                setFormation(e.target.value)
            }} className="input_inscription_apprenant" required/>
            <input type="text" name="promotion" defaultValue={promotion} placeholder="Promotion" onChange={(e) => {
